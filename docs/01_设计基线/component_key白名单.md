...
| `services_page` | 服务矩阵页（成员4待补页面组件） | **子页面**：服务矩阵页（2026-05-30 新增） |
| `conference_page` | 学术会议页（成员4待补页面组件） | **子页面**：学术会议页（2026-05-30 新增） |
...
| 学术会议页 | `conference_page` | `/conference` 311 | 成员4 新增页面组件 |
| 正文内容页 | `rich_text` | `/about/introduction` 312 等 | `RichTextBlock` |
